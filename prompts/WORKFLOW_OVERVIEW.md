...
| **Step 3 Experiment** | 单节点串行：规划控制变量与预算 → 开工前自查代码/配置并就地修补 → 占卡训练与统一尺子全量评测 | 获胜的 `hypothesis.md` | `research/nodes/n{seq}-hyp-c{win}/experiment.md`<br>`research/nodes/n{seq}-hyp-c{win}/model/` |
